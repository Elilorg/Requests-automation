...
class DriverAugmente(webdriver.Chrome) : 
    def __init__(self, chrome_options = None, headless=False, teardown=False) : 
        ...
        user_agent = 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/100.0.3112.50 Safari/537.36'    
        chrome_options.add_argument('user-agent={0}'.format(user_agent))
        chrome_options.add_experimental_option('prefs', {'intl.accept_languages': 'fr'})
        chrome_options.add_extension('./extentions/Buster-Captcha-Solver-for-Humans.crx')
